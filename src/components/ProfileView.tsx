        ...
        {currentUser ? (
          ...
          <div className="flex flex-col gap-3.5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-[#242A26]">سجّل دخولك لحفظ ومزامنة حسابك سحابياً</h4>
                <p className="text-[11px] text-[#606963] mt-0.5 leading-relaxed">
                  اربط حسابك مع Firebase لحفظ وصفاتك، مفضلتك، وقوائم المشتريات والوصول إليها من أي جهاز.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl bg-white border border-[#EDE7DD] shadow-2xs hover:bg-[#FAF8F5] text-xs font-bold text-[#242A26] transition active:scale-95 disabled:opacity-50"
              >
                ...
                <span>{isLoggingIn ? 'جاري الاتصال...' : 'الدخول السريع بـ Google'}</span>
              </button>

              <button
                onClick={() => setIsAuthModalOpen(true)}
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl bg-[#4E7659] text-white shadow-2xs hover:bg-[#3d5e46] text-xs font-bold transition active:scale-95"
              >
                <Mail className="w-4 h-4" />
                <span>الدخول أو التسجيل بالإيميل</span>
              </button>
            </div>
          </div>
        )}
